            ...
            <div className="flex flex-col items-center justify-start min-h-full w-full pt-2 pl-5 pr-5 pb-5 rounded-t-lg md:w-3/5 md:rounded-tr-none md:rounded-l-lg">
              ...
              <div className="flex flex-col justify-center items-center w-full min-h-full">
                ...
                <div className="mt-5 flex flex-col space-y-1 items-start">
                  ...
                  <input type="text" placeholder="Email" className="border border-solid border-lightGreen outline-green rounded-lg px-2 py-1 text-sm transition
          ease-in-out" />
                </div>

                <div className="mt-2 flex flex-col space-y-1 items-start">
                  <label htmlFor="password" className="text-xs">Password</label>
                  <input type="password" placeholder="Password" className="border border-solid border-lightGreen outline-green rounded-lg px-2 py-1 text-sm transition
          ease-in-out" />
                </div>
                ...
                <div className="mt-3 w-1/2 text-sm">
                  <Button link="sadasd" value="Sign in" roundness="lg" height="1" hidden={false} />
                </div>
